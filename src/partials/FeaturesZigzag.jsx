      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20 border-t border-gray-800">
          ...
          <div className="timeline grid gap-20">
            {/* 1st item */}
            <div className="timeline-item-left md:grid md:grid-cols-12 md:gap-6 items-center">
            <div className="timeline-icon"></div>
              {/* Content */}
              <div className="timeline-content right max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3 mb-3">Engineer</h3>
                  <h3 className="h6 mb-6">NTT DATA Europe & Latam</h3>
            ...
            <div className=" timeline-item-right md:grid md:grid-cols-12 md:gap-6 items-center">
              {/* Content */}
              <div className="timeline-content left max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-left">

                <div className="md:pl-4 lg:pl-12 xl:pl-16">
                  <h3 className="h3 mb-3">Junior Engineer</h3>
                  <h3 className="h6 mb-6">NTT DATA Europe & Latam</h3>
                  <p className="text-xl text-gray-400 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
            ...
            <div className="timeline-icon"></div>
              ...
              <div className="timeline-content right max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6" data-aos="fade-right">
                <div className="md:pr-4 lg:pr-12 xl:pr-16">
                  <h3 className="h3 mb-3">Solution Assistant</h3>
                  <h3 className="h6 mb-6">Everis</h3>
                  <p className="text-xl text-gray-400 mb-4">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.</p>
                  <ul className="text-lg text-gray-400 -mb-2">
                    <li className="flex items-center mb-2">
                      <svg className="w-3 h-3 fill-current text-green-500 mr-2 shrink-0" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg">
