            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6">
                <div className="py-12 md:py-20 border-t border-gray-800">
                    ...
                    <div className="max-w-sm mx-auto grid gap-8 lg:grid-cols-2 lg:gap-6 items-start lg:max-w-none">
                        <div className="flex flex-col h-full p-6 bg-800" data-aos="fade-up" data-aos-delay="200">
                            <div>
                            ...
                            <h4 className="h4 mb-10">GRADO EN INGENIERÍA, INGENIERÍA MULTIMÉDIA</h4>

                            <blockquote className="text-lg text-gray-400 grow">Universitat Ramon Llull</blockquote>
                            <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                                <cite className="text not-italic">2014 - 2021</cite>
                            </div>
                        </div>
                        <div className="flex flex-col h-full p-6 bg-800" data-aos="fade-up">
                            <div>
                                <div className="relative inline-flex flex-col mb-4">
                            ...
                            <blockquote className="text-lg text-gray-400 grow">Universitat Ramon Llull</blockquote>
                            <div className="text-gray-700 font-medium mt-6 pt-5 border-t border-gray-700">
                                <cite className="text not-italic">2021-2022</cite>
                            </div>
                        </div>
